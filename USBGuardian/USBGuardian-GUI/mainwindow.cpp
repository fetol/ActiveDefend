...
{
    QMessageBox messageBox;
    messageBox.setText("Chcete odstrániť infikované súbory?");
    messageBox.setIcon(QMessageBox::Warning);
    messageBox.setStandardButtons(QMessageBox::Yes | QMessageBox::Cancel);
...
{
    QMessageBox messageBox;
    messageBox.setWindowTitle("Formátovanie kľúča USB");
    messageBox.setText("Chcete naformátovať kľúč USB? Všetky údaje sa stratia!");
    messageBox.setIcon(QMessageBox::Warning);
    messageBox.setStandardButtons(QMessageBox::Yes | QMessageBox::Cancel);
...
void MainWindow::formatUSB(){
    ...
    QMessageBox messageBox;
    messageBox.setText("Váš USB kľúč bol naformátovaný.");
...
{
    ui->label_exception_title->setText("Upozornenie: kľúč USB bol odstránený !");
    ui->stackedWidget->setCurrentIndex(4);
}
